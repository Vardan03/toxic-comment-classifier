...
class LSTMModel(nn.Module):
    ...
    def fit(
        ...
        print(f"[LSTMModel] params = {n_params:,}")
    ...
    def load(self, path: str) -> "LSTMModel":
        ...
        self.load_state_dict(
            torch.load(os.path.join(path, "weights_lstm.pt"), map_location=self._device), 
            strict=False
        )
        self.eval()
